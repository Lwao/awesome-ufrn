Z1 = 200; Z2 = Z1;   % impendancia caracteristica das linhas [ohm]
...
Vf = Tt*Tt2*E;       % tensao no final da linha (dominio de Laplace)
lsim(Tt*Tt2,e,t); legend('Tensao no fim da linha')