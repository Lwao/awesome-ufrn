...
void SIM1_init__(SIM1 *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->NDES,1,retain)
  __INIT_VAR(data__->SOL_A,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->SOL_B,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->S_TV,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->S_TC,__BOOL_LITERAL(FALSE),retain)
...
// Actions definitions
#define __SFC_SOL_A 0
#define __SFC_M 1
#define __SFC_SOL_B 2
...
void SIM1_body__(SIM1 *data__) {
  ...
  if (__GET_VAR(data__->E0.X)) {
    __SET_VAR(data__->,__transition_list[0],,(__GET_VAR(data__->LIG,) && __GET_VAR(data__->NDES,)));
    if (__DEBUG) {
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[0],,(__GET_VAR(data__->LIG,) && __GET_VAR(data__->NDES,)));
    }
    __SET_VAR(data__->,__transition_list[0],,0);
  }
  if (__GET_VAR(data__->E1.X)) {
    __SET_VAR(data__->,__transition_list[1],,((__GET_VAR(data__->S_TC,) && __GET_VAR(data__->S_TV,)) && __GET_VAR(data__->NDES,)));
    if (__DEBUG) {
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[1],,((__GET_VAR(data__->S_TC,) && __GET_VAR(data__->S_TV,)) && __GET_VAR(data__->NDES,)));
    }
    __SET_VAR(data__->,__transition_list[1],,0);
  }
  if (__GET_VAR(data__->E2.X)) {
    __SET_VAR(data__->,__transition_list[2],,(!(__GET_VAR(data__->M,)) && __GET_VAR(data__->NDES,)));
    if (__DEBUG) {
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[2],,(!(__GET_VAR(data__->M,)) && __GET_VAR(data__->NDES,)));
    }
    __SET_VAR(data__->,__transition_list[2],,0);
  }
  if (__GET_VAR(data__->E3.X)) {
    __SET_VAR(data__->,__transition_list[3],,(!(__GET_VAR(data__->S_TC,)) && !(__GET_VAR(data__->S_TV,))));
    if (__DEBUG) {
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[3],,(!(__GET_VAR(data__->S_TC,)) && !(__GET_VAR(data__->S_TV,))));
    }
    __SET_VAR(data__->,__transition_list[3],,0);
  }
  if (__GET_VAR(data__->E2.X)) {
    __SET_VAR(data__->,__transition_list[4],,!(__GET_VAR(data__->NDES,)));
    if (__DEBUG) {
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[4],,!(__GET_VAR(data__->NDES,)));
    }
    __SET_VAR(data__->,__transition_list[4],,0);
  }
  if (__GET_VAR(data__->E1.X)) {
    __SET_VAR(data__->,__transition_list[5],,!(__GET_VAR(data__->NDES,)));
    if (__DEBUG) {
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[5],,!(__GET_VAR(data__->NDES,)));
    }
  ...
  // E1 action associations
  {
    ...
    if (active)       {__SET_VAR(data__->,SOL_A,,1);};
    if (desactivated) {__SET_VAR(data__->,SOL_A,,0);};
  ...
  // E3 action associations
  {
    ...
    if (active)       {__SET_VAR(data__->,SOL_B,,1);};
    if (desactivated) {__SET_VAR(data__->,SOL_B,,0);};
  ...
  // Actions execution
  if (data__->__action_list[__SFC_SOL_A].reset) {
    __SET_VAR(data__->,SOL_A,,0);
  }
  else if (data__->__action_list[__SFC_SOL_A].set) {
    __SET_VAR(data__->,SOL_A,,1);
  }
  ...
  if (data__->__action_list[__SFC_SOL_B].reset) {
    __SET_VAR(data__->,SOL_B,,0);
  }
  else if (data__->__action_list[__SFC_SOL_B].set) {
    __SET_VAR(data__->,SOL_B,,1);
  }
