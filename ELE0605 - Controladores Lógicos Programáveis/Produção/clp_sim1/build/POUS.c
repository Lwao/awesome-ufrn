...
void SIM2_body__(SIM2 *data__) {
  ...
  if (__GET_VAR(data__->E3.X)) {
    __SET_VAR(data__->,__transition_list[3],,__GET_VAR(data__->DES,));
    if (__DEBUG) {
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[3],,__GET_VAR(data__->DES,));
    }
  ...
  // E2 action associations
  {
    ...
    if (active && __time_cmp(data__->E2.T.value, __time_to_timespec(1, 0, 5, 0, 0, 0)) >= 0) 
...
void SIM1_init__(SIM1 *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->S_H,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->V_A,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->V_B,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->V_C,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->V_D,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->V_S,__BOOL_LITERAL(FALSE),retain)
...
#define E1 __step_list[1]
#define __SFC_E1 1
#define E4 __step_list[2]
#define __SFC_E4 2
#define E5 __step_list[3]
#define __SFC_E5 3
#define E2 __step_list[4]
#define __SFC_E2 4
#define E3 __step_list[5]
#define __SFC_E3 5
...
void SIM1_body__(SIM1 *data__) {
  ...
  // Transitions fire test
  if (__GET_VAR(data__->E0.X)) {
    __SET_VAR(data__->,__transition_list[0],,(!(__GET_VAR(data__->S_L,)) && !(__GET_VAR(data__->S_H,))));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[0],,__GET_VAR(data__->__transition_list[0]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[0],,(!(__GET_VAR(data__->S_L,)) && !(__GET_VAR(data__->S_H,))));
    }
    __SET_VAR(data__->,__transition_list[0],,0);
  }
  if (__GET_VAR(data__->E1.X) && __GET_VAR(data__->E2.X) && __GET_VAR(data__->E3.X)) {
    __SET_VAR(data__->,__transition_list[1],,(__GET_VAR(data__->S_L,) && __GET_VAR(data__->S_H,)));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[1],,__GET_VAR(data__->__transition_list[1]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[1],,(__GET_VAR(data__->S_L,) && __GET_VAR(data__->S_H,)));
    }
    __SET_VAR(data__->,__transition_list[1],,0);
  }
  if (__GET_VAR(data__->E4.X)) {
    __SET_VAR(data__->,__transition_list[2],,!(__GET_VAR(data__->S_H,)));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[2],,__GET_VAR(data__->__transition_list[2]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[2],,!(__GET_VAR(data__->S_H,)));
    }
    __SET_VAR(data__->,__transition_list[2],,0);
  }
  if (__GET_VAR(data__->E5.X)) {
    __SET_VAR(data__->,__transition_list[3],,!(__GET_VAR(data__->S_L,)));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[3],,__GET_VAR(data__->__transition_list[3]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[3],,!(__GET_VAR(data__->S_L,)));
    }
    __SET_VAR(data__->,__transition_list[3],,0);
  }
  ...
  // E1 action associations
  {
    ...
    if (active)       {__SET_VAR(data__->,V_A,,1);};
    if (desactivated) {__SET_VAR(data__->,V_A,,0);};
  ...
  // E4 action associations
  {
    ...
    if (active)       {__SET_VAR(data__->,V_S,,1);};
    if (desactivated) {__SET_VAR(data__->,V_S,,0);};
  ...
  // E5 action associations
  {
    ...
    if (active && __time_cmp(data__->E5.T.value, __time_to_timespec(1, 0, 10, 0, 0, 0)) < 0) 
                      {__SET_VAR(data__->,V_D,,1);}
    else if (desactivated || active)
                      {__SET_VAR(data__->,V_D,,0);};
  ...
  // E2 action associations
  {
    ...
    if (active)       {__SET_VAR(data__->,V_B,,1);};
    if (desactivated) {__SET_VAR(data__->,V_B,,0);};
  ...
  // E3 action associations
  {
    ...
    if (active)       {__SET_VAR(data__->,V_C,,1);};
    if (desactivated) {__SET_VAR(data__->,V_C,,0);};
  ...
  // Actions execution
  if (data__->__action_list[__SFC_V_A].reset) {
    __SET_VAR(data__->,V_A,,0);
  }
  else if (data__->__action_list[__SFC_V_A].set) {
    __SET_VAR(data__->,V_A,,1);
  }
  if (data__->__action_list[__SFC_V_S].reset) {
    __SET_VAR(data__->,V_S,,0);
  }
  else if (data__->__action_list[__SFC_V_S].set) {
    __SET_VAR(data__->,V_S,,1);
  }
  if (data__->__action_list[__SFC_V_D].reset) {
    __SET_VAR(data__->,V_D,,0);
  }
  else if (data__->__action_list[__SFC_V_D].set) {
    __SET_VAR(data__->,V_D,,1);
  }
  ...
  if (data__->__action_list[__SFC_V_B].reset) {
    __SET_VAR(data__->,V_B,,0);
  }
  else if (data__->__action_list[__SFC_V_B].set) {
    __SET_VAR(data__->,V_B,,1);
  }
  if (data__->__action_list[__SFC_V_C].reset) {
    __SET_VAR(data__->,V_C,,0);
  }
  else if (data__->__action_list[__SFC_V_C].set) {
    __SET_VAR(data__->,V_C,,1);
  }
