...
.data
    ...
    opcao db ?
    string1 db 'AJSUA','$'
    compString1 dw $ - string1 - 1
    string2 db 'AJSUD','$'
    compString2 dw $ - string2 - 1
...
SubString PROC
    mov ah,byte ptr compString1
    cmp ah,byte ptr compString2
    je testEQU
    ...
    testEQU:
        xor si,si
        mov cx,compString1 ; whatever since both are equal
        loopEQU:
            mov al,string1[si]
