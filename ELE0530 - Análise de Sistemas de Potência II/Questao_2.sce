...
n:
    barra em que ocorreu o curto-circuito
 
Ib1, Ib2, Vb1, Vb2, Sb:
    valores de base

ICC_3f,ICC_2f,ICC_1f:
    correntes de curto-circuito nas barras para curto trifásico/bifásico/monofásico na barra escolhida
    
    LINHA 1 - comp. de seq.+, LINHA 2 - comp. seq.-, LINHA 3 - comp. seq.0

VCC_3f, VCC_2f, VCC_1f:
    tensões nas barras para curto trifásico/bifásico/monofásico na barra escolhida
