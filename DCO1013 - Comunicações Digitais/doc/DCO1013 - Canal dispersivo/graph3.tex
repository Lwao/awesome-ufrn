...
\begin{axis}[very thick,
            ...
            % waveform
            \addplot[mark=none] coordinates {(1,0) (2,0.5)};
            \addplot[mark=none] coordinates {(2,0.5) (3,2)};
            \addplot[mark=none] coordinates {(3,2) (4,)};
...
\end{tikzpicture}
\end{center}
\caption{Forma de onda do sinal $y(t)$ completa, com: $t_d>T$.}
\label{graph:2} 
\end{figure}