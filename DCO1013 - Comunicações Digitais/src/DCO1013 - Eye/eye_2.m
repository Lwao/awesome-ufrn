% Gerar diagramas de olho para mensagens quaternárias formatadas por 
...
msg.data = sign(randn(1,msg.size))+2*sign(randn(1,msg.size)); % mensagem PAM quaternária aleatória 
...
% eyediagram
% 1º argumento: número de amostras que serão traçadas por ciclo na janela
% 2º argumento: define os rótulos do eixo x para -#argumento/2 até #argumento/2
% 3º argumento: causa um deslocamento de #argumento+1 no sinal que vai aparecer na janela 
